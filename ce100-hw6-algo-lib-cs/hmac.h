...
namespace shoc {
	...
	* @name  hmac
	*
	* @brief it is hmac function
	*
	* @param [in] fimsg [\b string]  function index
	*
	* @param [in] fimsg_len [\b string]  function index
	*
	* @param [in] fikey [\b int]  function index
	* 
	* @param [in] fikey_len [\b int]  function index
	* 
	* @param [in] fidigest [\b int]  function index
	*
	**/
